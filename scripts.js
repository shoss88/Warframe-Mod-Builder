/**
 * warframesArray:
 * Creates an array of warframes and their info.
 * @return {array} - returns an array of objects representing warframes.
 */
function warframesArray(){
    /**
...
/**
 * plugInSpecificValues:
 * Uses binary search on the warframes array to find the clicked element and change DOM accordingly.
 * @return {int} - returns the final index within the warframes array specifying the clicked warframe.
 */
function plugInSpecificValues(){
    let warframes = warframesArray();
...
let currentWarframeIndex = plugInSpecificValues();

/**
 * addOpenDropdownToButtons:
 * Adds a click event listener to all current polarity buttons
 * @return {void} Nothing
 */
function addOpenDropdownToButtons(){
...
/**
 * addChangePolarityToButtons:
 * Adds a click event listener to every polarity button.
 * @return {void} Nothing
 */
function addChangePolarityToButtons(){
